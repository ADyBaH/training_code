...
Output
Output will consist of a list of string
values (in Haskell and C: Open or Senior) stating
whether the respective member is to be
...
const openOrSenior = (data) =>
  data.map((tuple) => (tuple[0] >= 55 && tuple[1] > 7 ? "Senior" : "Open"));
