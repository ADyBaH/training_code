...
You are given an integer array candies, where each candies[i] 
...
var kidsWithCandies = function(candies, extraCandies) {
  const maxCandiesNumber = Math.max(...candies)
  return candies.map(value => value + extraCandies >= maxCandiesNumber)
};