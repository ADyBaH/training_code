...
type MyAwaitedCase1 = MyAwaited<X>; //, string>
type MyAwaitedCase2 = MyAwaited<Y>; //, { field: number }>
type MyAwaitedCase3 = MyAwaited<Z>; //, string | number>
type MyAwaitedCase4 = MyAwaited<Z1>; //, string | boolean>
type MyAwaitedCase5 = MyAwaited<T>; //, number>
